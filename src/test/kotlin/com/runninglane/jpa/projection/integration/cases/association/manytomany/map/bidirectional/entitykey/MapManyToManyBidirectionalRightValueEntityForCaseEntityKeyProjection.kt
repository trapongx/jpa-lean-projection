...
class MapManyToManyBidirectionalRightValueEntityForCaseEntityKeyProjection {
    var id: Long = 0L
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is MapManyToManyBidirectionalRightValueEntityForCaseEntityKeyProjection) return false
        return id == other.id
    }
}