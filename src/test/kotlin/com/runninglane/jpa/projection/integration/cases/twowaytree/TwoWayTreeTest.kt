...
import com.runninglane.jpa.projection.mapper.EntityPropertyMapperUsingFetcher
...
@DataJpaTest
@ContextConfiguration(classes = [TwoWayTreeTestConfig::class])
class TwoWayTreeTest : BaseTest() {
    ...
    fun `should correctly create mappers`() {
        ...
        val mapperAssertion = expectEntityClassMapper {
            ...
            expectMapper("children", EntityPropertyMapperUsingFetcher::class)
