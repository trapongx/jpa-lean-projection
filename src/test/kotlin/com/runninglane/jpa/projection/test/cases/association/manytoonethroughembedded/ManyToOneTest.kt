...
class ManyToOneTest : BaseTest() {
    ...
    fun `should correctly project unidirectional many-to-one association`() {
        ...
        val leftEntity1 = ManyToOneUnidirectionalLeftEntity().apply {
            right = ManyToOneUnidirectionalRightEmbeddable().apply {
                entity = rightEntity1
            }
        }.also { entityManager.persist(it) }
        ...
        projectAndVerify(
            ...
            verifyEach(
                ...
                assertThat(projection.right!!.entity!!.id).isEqualTo(entity.right!!.entity!!.id)
                assertThat(projection.right!!.entity!!.int).isEqualTo(entity.right!!.entity!!.int)
                assertThat(projection.right!!.entity!!.string).isEqualTo(entity.right!!.entity!!.string)
            }
            ...
            assertThat(rightProjection1FromLeftProjection1?.entity).isSameAs(rightProjection1FromLeftProjection2?.entity)
            assertThat(rightProjection1FromLeftProjection1?.entity?.id).isEqualTo(rightEntity1.id)
            assertThat(rightProjection2?.entity?.id).isEqualTo(rightEntity2.id)

            // Assert that simple values are properly set
            assertThat(rightProjection1FromLeftProjection1?.entity?.int).isEqualTo(rightEntity1.int).isEqualTo(1101)
            assertThat(rightProjection1FromLeftProjection1?.entity?.string).isEqualTo(rightEntity1.string).isEqualTo("Test1")
            assertThat(rightProjection2?.entity?.int).isEqualTo(rightEntity2.int).isEqualTo(2202)
            assertThat(rightProjection2?.entity?.string).isEqualTo(rightEntity2.string).isEqualTo("Test2")
        }
    ...
    fun `should correctly project bidirectional many-to-one association`() {
        ...
        val leftEntity1 = ManyToOneBidirectionalLeftEntity().apply {
            right = ManyToOneBidirectionalRightEmbeddable().apply {
                entity = rightEntity1
            }
        }.also { entityManager.persist(it) }
        ...
        projectAndVerify(
            ...
            val rightProjections = projections.map { it.right!!.entity!! }
            ...
            // Assert that projections of the same entity are reused
            assertThat(leftProjection1.right?.entity?.id).isEqualTo(rightEntity1.id)
            assertThat(leftProjection2.right?.entity?.id).isEqualTo(rightEntity1.id)
            assertThat(leftProjection1.right?.entity).isSameAs(leftProjection2.right?.entity)
            assertThat(leftProjection3.right?.entity?.id).isEqualTo(rightEntity2.id)
