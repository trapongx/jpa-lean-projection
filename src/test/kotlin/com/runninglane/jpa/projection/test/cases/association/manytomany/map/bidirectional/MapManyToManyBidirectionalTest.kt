package com.runninglane.jpa.projection.test.cases.association.manytomany.map.bidirectional

import com.runninglane.jpa.projection.test.BaseTest
import com.runninglane.jpa.projection.test.EntityManagerWithCounter
import com.runninglane.jpa.projection.test.cases.association.manytomany.map.bidirectional.entitykey.*
import com.runninglane.jpa.projection.test.cases.association.manytomany.map.bidirectional.stringkey.MapManyToManyBidirectionalLeftEntityWithStringKey
import com.runninglane.jpa.projection.test.cases.association.manytomany.map.bidirectional.stringkey.MapManyToManyBidirectionalLeftEntityWithStringKeyProjection
import com.runninglane.jpa.projection.test.cases.association.manytomany.map.bidirectional.stringkey.MapManyToManyBidirectionalLeftEntityWithStringKeyProjectionWithProjectedValue
import com.runninglane.jpa.projection.test.cases.association.manytomany.map.bidirectional.stringkey.MapManyToManyBidirectionalRightValueEntityForCaseStringKey
